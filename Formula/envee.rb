class Envee < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/jackjakarta/envee/releases/download/0.1.0/envee-darwin-arm64.tar.gz"
      sha256 "d7a45103357689f42ef250d02911bc7cc05b929cb112dc6e188b66ae2bb8aeee"
    else
      url "https://github.com/jackjakarta/envee/releases/download/0.1.0/envee-darwin-amd64.tar.gz"
